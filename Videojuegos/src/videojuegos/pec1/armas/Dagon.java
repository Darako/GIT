...
public class Dagon {
    ...
    //CONSTRUCTOR
    public Dagon(String nombre, int durabilidad, int ataque, int ataque_magico) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Dagon{" + "nombre=" + nombre + ", durabilidad=" + durabilidad + ", ataque=" + ataque + ", ataque_magico=" + ataque_magico + '}';
    }
