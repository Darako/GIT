...
public class Casco implements Serializable{
    ...
    //CONSTRUCTOR
    public Casco(String nombre, int durabilidad, int pv, int pm, int defensa, int defensa_magica) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Casco{" + "nombre=" + nombre + ", durabilidad=" + durabilidad + ", pv=" + pv + ", pm=" + pm + ", defensa=" + defensa + ", defensa_magica=" + defensa_magica + '}';
    }
