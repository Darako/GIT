 ...
 * @author Jorge
 */
public class Botas implements Serializable{
    ...
    public String toString() {
        return "Botas{" + "nombre=" + nombre + ", durabilidad=" + durabilidad + ", pv=" + pv + ", pm=" + pm + ", defensa=" + defensa + ", defensa_magica=" + defensa_magica + '}';
    }
